...
module.exports.parseFull = function(id, content, path) {
  ...
  const autoGoals = 'x-blank, x-blank-input, x-equation, x-var, x-slider, .next-step, x-sortable, x-gameplay, x-slideshow .slide, x-slideshow .legend, x-picker .item:not([data-error]), x-code-checker';
